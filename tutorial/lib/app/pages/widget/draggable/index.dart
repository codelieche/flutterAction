...
class DraggableIndexPage extends StatefulWidget {
  DraggableIndexPage({Key key}) : super(key: key);

  @override
  _DraggableIndexPageState createState() => _DraggableIndexPageState();
}

class _DraggableIndexPageState extends State<DraggableIndexPage>
