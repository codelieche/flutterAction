...
class ExpansionTileIndexPage extends StatefulWidget {
  ExpansionTileIndexPage({Key key}) : super(key: key);

  @override
  _ExpansionTileIndexPageState createState() => _ExpansionTileIndexPageState();
}

class _ExpansionTileIndexPageState extends State<ExpansionTileIndexPage>
  ...
  Widget build(BuildContext context) {
    ...
    Scaffold scaffold = Scaffold(
      ...
      body: TabBarView(
        children: [
          ExpansionTileBaseDemoPage(),
          ExpansionPanelListBaseDemoPage(),
        ],
        controller: _tabController,
      ),
    );
