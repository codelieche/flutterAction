...
class BottomNavigationBarDemoPage01 extends StatefulWidget {
  BottomNavigationBarDemoPage01({Key key}) : super(key: key);

  @override
  _BottomNavigationBarDemoPage01State createState() =>
      _BottomNavigationBarDemoPage01State();
}

class _BottomNavigationBarDemoPage01State
    extends State<BottomNavigationBarDemoPage01> {
