...
Map<String, Function> routes = {
  "/": (content, {int arguments}) => AppHomeTabs(currentIndex: arguments != null ?  arguments : 0),
  "/home": (context) => HomeIndexPage(),
  "/widget": (context) => WidgetIndexPage(),
  "/page": (context) => PageDemoIndexPage(),
  "/user": (context) => UserIndexPage(),
};

var addAllRoutesLock = false;   // 添加路由的锁
// 子页面路由：方便管理
List<Map<String, Function>> subRoutes = [widgetRoutes, pageRoutes];
